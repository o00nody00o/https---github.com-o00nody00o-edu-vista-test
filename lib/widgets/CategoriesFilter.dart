...
String? text;
   CategoriesFilter({super.key,required this.text,required this.containerwidth,required this.containerheight,required this.fontSize,required this.fontWeight,});
...
class mycourse extends StatelessWidget {
  ...
  String? courseName;
   ...
   mycourse({super.key,required this .bigImage,
