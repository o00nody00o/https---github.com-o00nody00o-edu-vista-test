...
class _CoursesPageState extends State<CoursesPage> {
  ...
  String selectedTab = 'All'; // Initially selected tab
  List<String> filterTabs = [
    'All', 'Java', 'C++', 'C+', 'Python', 'Flutter', 
    'Machine Learning', 'UX/UI', 'Business', 'Software Engineering'
  ];

  // Firestore instance
  FirebaseFirestore firestore = FirebaseFirestore.instance;

  // Variable to hold courses
  ...
  void fetchCourses() async {
    ...
    if (selectedTab == 'All') {
      ...
      // Fetch courses where 'courseTitle' matches the selected tab
    ...
    setState(() {
      courses = snapshot.docs.map((doc) => doc.data() as Map<String, dynamic>).toList();
    });
  }
  ...
  Widget build(BuildContext context) {
    return 
    Scaffold( backgroundColor: const Color.fromARGB(255, 255, 255, 255),
        ...
        children: [
              ...
              children: filterTabs.map((tab) {
                return GestureDetector(
                  onTap: () {
                    setState(() {
                      selectedTab = tab;
                      fetchCourses(); // Fetch courses based on selected tab
                    });
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: selectedTab == tab ? const Color(0xFFEFC539): Colors.grey[300],
                      borderRadius: BorderRadius.circular(20),
                    ),
                    child: Text(
                      tab,
                      style: TextStyle(fontSize:selectedTab == tab ? 25 :15, 
          ...
          Expanded(
            child: courses.isEmpty
                ? Center(child: Text('No courses found related to this Category'))
                : ListView.builder(
